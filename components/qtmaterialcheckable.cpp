...
void QtMaterialCheckablePrivate::init()
{
    ...
    checkedIcon = new QtMaterialCheckableIcon(QIcon(":/icons/toggle/svg/production/ic_check_box_24px.svg"), q);
    uncheckedIcon = new QtMaterialCheckableIcon(QIcon(":/icons/toggle/svg/production/ic_check_box_outline_blank_24px.svg"), q);
