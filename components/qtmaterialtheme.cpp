...
{
    setColor("primary1", Material::blue700);
    //    setColor("primary2", Material::cyan700);
    setColor("primary2", QColor("#2a2b40"));
...
{
    return QIcon(":/icons/" % category % "/svg/production/ic_" % icon % "_24px.svg");
}
